...
module Dashboards {
  ...
  class GrafanaResource extends AzureResource {
     ...
     */
    GrafanaResource() { this.getResourceType().regexpMatch("^Microsoft.Dashboard/grafana@.*") }
  ...
  module GrafanaProperties {
    ...
    class Properties extends ResourceProperties {
       ...
       */
      string deterministicOutboundIP() { result = this.getDeterministicOutboundIP().getValue() }

      /**
       * Returns true if deterministicOutboundIP is defined.
       */
      predicate hasDeterministicOutboundIP() { exists(this.getDeterministicOutboundIP()) }
       ...
       */
      predicate hasEnterpriseConfigurations() { exists(this.getEnterpriseConfigurations()) }
       ...
       */
      predicate hasGrafanaConfigurations() { exists(this.getGrafanaConfigurations()) }
       ...
       */
      predicate hasGrafanaIntegrations() { exists(this.getGrafanaIntegrations()) }

      /**
       * Returns the grafanaMajorVersion property.
       */
      StringLiteral getGrafanaMajorVersion() { result = this.getProperty("grafanaMajorVersion") }

      /**
       * Returns the value of the grafanaMajorVersion.
       */
      string grafanaMajorVersion() { result = this.getGrafanaMajorVersion().getValue() }

      /**
       * Returns true if grafanaMajorVersion is defined.
       */
      predicate hasGrafanaMajorVersion() { exists(this.getGrafanaMajorVersion()) }

      /**
       * Returns the grafanaPlugins property.
       */
      Object getGrafanaPlugins() { result = this.getProperty("grafanaPlugins") }

      /**
       * Returns true if grafanaPlugins is defined.
       */
      predicate hasGrafanaPlugins() { exists(this.getGrafanaPlugins()) }
       ...
       */
      predicate hasZoneRedundancy() { exists(this.getZoneRedundancy()) }
    ...
    class EnterpriseConfigurations extends Object {
       ...
       */
      StringLiteral getMarketplaceAutoRenew() { result = this.getProperty("marketplaceAutoRenew") }

      /**
       * Returns the value of the marketplaceAutoRenew ('Enabled' or 'Disabled').
       */
      string marketplaceAutoRenew() { result = this.getMarketplaceAutoRenew().getValue() }

      /**
       * Returns true if marketplaceAutoRenew is defined.
       */
      predicate hasMarketplaceAutoRenew() { exists(this.getMarketplaceAutoRenew()) }

      /**
       * Returns the marketplacePlanId property.
       */
      StringLiteral getMarketplacePlanId() { result = this.getProperty("marketplacePlanId") }

      /**
       * Returns the value of the marketplacePlanId.
       */
      string marketplacePlanId() { result = this.getMarketplacePlanId().getValue() }

      /**
       * Returns true if marketplacePlanId is defined.
       */
      predicate hasMarketplacePlanId() { exists(this.getMarketplacePlanId()) }

      override string toString() { result = "EnterpriseConfigurations" }
    }
    ...
    class GrafanaConfigurations extends Object {
       ...
       */
      Security getSecurity() { result = this.getProperty("security") }

      /**
       * Returns true if security is defined.
       */
      predicate hasSecurity() { exists(this.getSecurity()) }

      /**
       * Returns the smtp property.
       */
      Smtp getSmtp() { result = this.getProperty("smtp") }

      /**
       * Returns true if smtp is defined.
       */
      predicate hasSmtp() { exists(this.getSmtp()) }

      /**
       * Returns the snapshots property.
       */
      Snapshots getSnapshots() { result = this.getProperty("snapshots") }

      /**
       * Returns true if snapshots is defined.
       */
      predicate hasSnapshots() { exists(this.getSnapshots()) }
       ...
       */
      predicate hasUnifiedAlertingScreenshots() { exists(this.getUnifiedAlertingScreenshots()) }

      /**
       * Returns the users property.
       */
      Users getUsers() { result = this.getProperty("users") }

      /**
       * Returns true if users is defined.
       */
      predicate hasUsers() { exists(this.getUsers()) }

      override string toString() { result = "GrafanaConfigurations" }
    }
    ...
    class Security extends Object {
       ...
       */
      boolean csrfAlwaysCheck() { result = this.getCsrfAlwaysCheck().getBool() }

      /**
       * Returns true if csrfAlwaysCheck is defined.
       */
      predicate hasCsrfAlwaysCheck() { exists(this.getCsrfAlwaysCheck()) }

      override string toString() { result = "Security" }
    }
    ...
    class Smtp extends Object {
       ...
       */
      boolean enabled() { result = this.getEnabled().getBool() }

      /**
       * Returns true if enabled is defined.
       */
      predicate hasEnabled() { exists(this.getEnabled()) }

      /**
       * Returns the fromAddress property.
       */
      StringLiteral getFromAddress() { result = this.getProperty("fromAddress") }

      /**
       * Returns the value of fromAddress.
       */
      string fromAddress() { result = this.getFromAddress().getValue() }

      /**
       * Returns true if fromAddress is defined.
       */
      predicate hasFromAddress() { exists(this.getFromAddress()) }

      /**
       * Returns the fromName property.
       */
      StringLiteral getFromName() { result = this.getProperty("fromName") }

      /**
       * Returns the value of fromName.
       */
      string fromName() { result = this.getFromName().getValue() }

      /**
       * Returns true if fromName is defined.
       */
      predicate hasFromName() { exists(this.getFromName()) }

      /**
       * Returns the host property.
       */
      StringLiteral getHost() { result = this.getProperty("host") }

      /**
       * Returns the value of host.
       */
      string host() { result = this.getHost().getValue() }

      /**
       * Returns true if host is defined.
       */
      predicate hasHost() { exists(this.getHost()) }

      /**
       * Returns the password property.
       */
      StringLiteral getPassword() { result = this.getProperty("password") }

      /**
       * Returns the value of password.
       */
      string password() { result = this.getPassword().getValue() }

      /**
       * Returns true if password is defined.
       */
      predicate hasPassword() { exists(this.getPassword()) }

      /**
       * Returns the skipVerify property.
       */
      Boolean getSkipVerify() { result = this.getProperty("skipVerify") }

      /**
       * Returns the value of skipVerify as a boolean.
       */
      boolean skipVerify() { result = this.getSkipVerify().getBool() }

      /**
       * Returns true if skipVerify is defined.
       */
      predicate hasSkipVerify() { exists(this.getSkipVerify()) }

      /**
       * Returns the startTLSPolicy property.
       */
      StringLiteral getStartTLSPolicy() { result = this.getProperty("startTLSPolicy") }

      /**
       * Returns the value of startTLSPolicy.
       */
      string startTLSPolicy() { result = this.getStartTLSPolicy().getValue() }

      /**
       * Returns true if startTLSPolicy is defined.
       */
      predicate hasStartTLSPolicy() { exists(this.getStartTLSPolicy()) }

      /**
       * Returns the user property.
       */
      StringLiteral getUser() { result = this.getProperty("user") }

      /**
       * Returns the value of user.
       */
      string user() { result = this.getUser().getValue() }

      /**
       * Returns true if user is defined.
       */
      predicate hasUser() { exists(this.getUser()) }

      override string toString() { result = "Smtp" }
    }
    ...
    class Snapshots extends Object {
       ...
       */
      Boolean getExternalEnabled() { result = this.getProperty("externalEnabled") }

      /**
       * Returns the value of externalEnabled as a boolean.
       */
      boolean externalEnabled() { result = this.getExternalEnabled().getBool() }

      /**
       * Returns true if externalEnabled is defined.
       */
      predicate hasExternalEnabled() { exists(this.getExternalEnabled()) }

      override string toString() { result = "Snapshots" }
    }
    ...
    class UnifiedAlertingScreenshots extends Object {
      ...
      UnifiedAlertingScreenshots() {
        this = grafanaConfigurations.getProperty("unifiedAlertingScreenshots")
      }

      /**
       * Returns the captureEnabled property.
       */
      Boolean getCaptureEnabled() { result = this.getProperty("captureEnabled") }

      /**
       * Returns the value of captureEnabled as a boolean.
       */
      boolean captureEnabled() { result = this.getCaptureEnabled().getBool() }

      /**
       * Returns true if captureEnabled is defined.
       */
      predicate hasCaptureEnabled() { exists(this.getCaptureEnabled()) }

      override string toString() { result = "UnifiedAlertingScreenshots" }
    }
    ...
    class Users extends Object {
       ...
       */
      Boolean getEditorsCanAdmin() { result = this.getProperty("editorsCanAdmin") }

      /**
       * Returns the value of editorsCanAdmin as a boolean.
       */
      boolean editorsCanAdmin() { result = this.getEditorsCanAdmin().getBool() }

      /**
       * Returns true if editorsCanAdmin is defined.
       */
      predicate hasEditorsCanAdmin() { exists(this.getEditorsCanAdmin()) }

      /**
       * Returns the viewersCanEdit property.
       */
      Boolean getViewersCanEdit() { result = this.getProperty("viewersCanEdit") }

      /**
       * Returns the value of viewersCanEdit as a boolean.
       */
      boolean viewersCanEdit() { result = this.getViewersCanEdit().getBool() }

      /**
       * Returns true if viewersCanEdit is defined.
       */
      predicate hasViewersCanEdit() { exists(this.getViewersCanEdit()) }

      override string toString() { result = "Users" }
    }
    ...
    class GrafanaIntegrations extends Object {
      ...
      override string toString() { result = "GrafanaIntegrations" }
    }
    ...
    class AzureMonitorWorkspaceIntegration extends Object {
      ...
      override string toString() { result = "AzureMonitorWorkspaceIntegration" }
    }
  }
}
